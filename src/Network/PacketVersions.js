...
*/
	...
	*/
		...
		*/
		...
		20140205: [
			[PACKET.CZ.REQUEST_ACT,0x0369,7,2,6],
			[PACKET.CZ.USE_SKILL,10,0x083C,2,4,6],
			[PACKET.CZ.REQUEST_MOVE,5,0x0437,2],
			[PACKET.CZ.REQUEST_TIME,6,0x035F,2],
			[PACKET.CZ.CHANGE_DIRECTION,5,0x0202,2,4],
			[PACKET.CZ.ITEM_PICKUP,6,0x07E4,2],
			[PACKET.CZ.ITEM_THROW,6,0x0362,2,4],
			[PACKET.CZ.MOVE_ITEM_FROM_BODY_TO_STORE,8,0x07EC,2,4],
			[PACKET.CZ.MOVE_ITEM_FROM_STORE_TO_BODY,8,0x0364,2,4],
			[PACKET.CZ.USE_SKILL_TOGROUND,10,0x0438,2,4,6,8],
			[PACKET.CZ.USE_SKILL_TOGROUNDMoreInfo,90,0x0366,2,4,6,8,10],
			[PACKET.CZ.REQNAME,6,0x096A,2],
			[PACKET.CZ.REQNAME_BYGID,6,0x0368,2],
			[PACKET.CZ.SSILIST_ITEM_CLICK,12,0x0838,2,6,10],
			[PACKET.CZ.SEARCH_STORE_INFO_NEXT_PAGE,2,0x0835,0],
			[PACKET.CZ.SEARCH_STORE_INFO,1,0x0819,2,4,5,9,13,14,15],
			[PACKET.CZ.REQ_TRADE_BUYING_STORE,1,0x0811,2,4,8,12],
			[PACKET.CZ.REQ_CLICK_TO_BUYING_STORE,6,0x0360,2],
			[PACKET.CZ.REQ_CLOSE_BUYING_STORE,2,0x0817,0],
			[PACKET.CZ.REQ_CLOSE_BUYING_STORE,1,0x0815,2,4,8,9,89],
			[PACKET.CZ.PARTY_BOOKING_REQ_REGISTER,18,0x0365,2,4],
			// packet(0x0363,8], // CZ_JOIN_BATTLE_FIELD
			[PACKET.CZ.ITEMLISTWIN_RES,1,0x0281,2,4,8],
			[PACKET.CZ.ENTER,19,0x022D,2,6,10,14,18],
			[PACKET.CZ.PARTY_JOIN_REQ,26,0x0802,2],
			// packet(0x0436,4], // CZ_GANGSI_RANK
			[PACKET.CZ.ADD_FRIENDS,26,0x023B,2],
			[PACKET.CZ.COMMAND_MER,5,0x0361,2,4],
			[PACKET.CZ.ACK_STORE_PASSWORD,36,0x0938,0],
			//[0x09df,7],
		],
		...
		20140305: [
			[PACKET.CZ.REQUEST_ACT,7,0x0369,2,6],
			[PACKET.CZ.USE_SKILL,10,0x083C,2,4,6],
			[PACKET.CZ.REQUEST_MOVE,5,0x0437,2],
			[PACKET.CZ.REQUEST_TIME,6,0x035F,2],
			[PACKET.CZ.CHANGE_DIRECTION,5,0x0815,2,4],
			[PACKET.CZ.ITEM_PICKUP,6,0x0202,2],
			[PACKET.CZ.ITEM_THROW,6,0x0362,2,4],
			[PACKET.CZ.MOVE_ITEM_FROM_BODY_TO_STORE,8,0x07EC,2,4],
			[PACKET.CZ.MOVE_ITEM_FROM_STORE_TO_BODY,8,0x0364,2,4],
			[PACKET.CZ.USE_SKILL_TOGROUND,10,0x0436,2,4,6,8],
			[PACKET.CZ.USE_SKILL_TOGROUNDMoreInfo,90,0x0366,2,4,6,8,10],
			[PACKET.CZ.REQNAME,6,0x096A,2],
			[PACKET.CZ.REQNAME_BYGID,6,0x0368,2],
			[PACKET.CZ.SSILIST_ITEM_CLICK,12,0x0838,2,6,10],
			...
			[PACKET.CZ.REQ_CLICK_TO_BUYING_STORE,6,0x0360,2],
			[PACKET.CZ.REQ_CLOSE_BUYING_STORE,2,0x0817,0],
			[PACKET.CZ.REQ_CLOSE_BUYING_STORE,1,0x0361,2,4,8,9,89],
			[PACKET.CZ.PARTY_BOOKING_REQ_REGISTER,18,0x0365,2,4],
			// packet(0x0363,8], // CZ_JOIN_BATTLE_FIELD
			[PACKET.CZ.ITEMLISTWIN_RES,1,0x0281,2,4,8],
			[PACKET.CZ.ENTER,19,0x0438,2,6,10,14,18],
			[PACKET.CZ.PARTY_JOIN_REQ,26,0x0802,2],
			// packet(0x0878,4], // CZ_GANGSI_RANK
			[PACKET.CZ.ADD_FRIENDS,26,0x07E4,2],
			[PACKET.CZ.COMMAND_MER,5,0x0934,2,4],
			[PACKET.CZ.ACK_STORE_PASSWORD,36,0x095e,0],
			//[0x09df,7],
		],
	};
});