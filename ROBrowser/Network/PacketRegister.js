...
define( ['./PacketStructure' ], function( PACKET )
{
	...
	return {
		...
		0xa3: PACKET.ZC.NORMAL_ITEMLIST,
		0xa4: PACKET.ZC.EQUIPMENT_ITEMLIST,
		0xa5: PACKET.ZC.STORE_NORMAL_ITEMLIST,
		0xa6: PACKET.ZC.STORE_EQUIPMENT_ITEMLIST,
		0xa8: PACKET.ZC.USE_ITEM_ACK,
		0xaa: PACKET.ZC.REQ_WEAR_EQUIP_ACK,
		0xac: PACKET.ZC.REQ_TAKEOFF_EQUIP_ACK,
		0xaf: PACKET.ZC.ITEM_THROW_ACK,
		...
		0xd6: PACKET.ZC.ACK_CREATE_CHATROOM,
		0xd7: PACKET.ZC.ROOM_NEWENTRY,
		0xd8: PACKET.ZC.DESTROY_ROOM,
		0xda: PACKET.ZC.REFUSE_ENTER_ROOM,
		0xdb: PACKET.ZC.ENTER_ROOM,
		0xdc: PACKET.ZC.MEMBER_NEWENTRY,
		0xdd: PACKET.ZC.MEMBER_EXIT,
		0xdf: PACKET.ZC.CHANGE_CHATROOM,
		0xe1: PACKET.ZC.ROLE_CHANGE,
		...
		0xf2: PACKET.ZC.NOTIFY_STOREITEM_COUNTINFO,
		0xf4: PACKET.ZC.ADD_ITEM_TO_STORE,
		0xf6: PACKET.ZC.DELETE_ITEM_FROM_STORE,
		0xf8: PACKET.ZC.CLOSE_STORE,
		0xfa: PACKET.ZC.ACK_MAKE_GROUP,
		0xfb: PACKET.ZC.GROUP_LIST,
		0xfd: PACKET.ZC.ACK_REQ_JOIN_GROUP,
		0xfe: PACKET.ZC.REQ_JOIN_GROUP,
		0x101: PACKET.ZC.GROUPINFO_CHANGE,
		0x104: PACKET.ZC.ADD_MEMBER_TO_GROUP,
		0x105: PACKET.ZC.DELETE_MEMBER_FROM_GROUP,
		0x106: PACKET.ZC.NOTIFY_HP_TO_GROUPM,
		0x107: PACKET.ZC.NOTIFY_POSITION_TO_GROUPM,
		0x109: PACKET.ZC.NOTIFY_CHAT_PARTY,
		0x10a: PACKET.ZC.MVP_GETTING_ITEM,
		0x10b: PACKET.ZC.MVP_GETTING_SPECIAL_EXP,
		0x10c: PACKET.ZC.MVP,
		0x10d: PACKET.ZC.THROW_MVPITEM,
		0x10e: PACKET.ZC.SKILLINFO_UPDATE,
		0x10f: PACKET.ZC.SKILLINFO_LIST,
		0x110: PACKET.ZC.ACK_TOUSESKILL, // ok
		0x111: PACKET.ZC.ADD_SKILL,
		0x114: PACKET.ZC.NOTIFY_SKILL, // ok
		0x115: PACKET.ZC.NOTIFY_SKILL_POSITION, // ok
		0x117: PACKET.ZC.NOTIFY_GROUNDSKILL,
		0x119: PACKET.ZC.STATE_CHANGE,
		0x11a: PACKET.ZC.USE_SKILL, // partially
		0x11c: PACKET.ZC.WARPLIST,
		0x11e: PACKET.ZC.ACK_REMEMBER_WARPPOINT,
		0x11f: PACKET.ZC.SKILL_ENTRY,
		0x120: PACKET.ZC.SKILL_DISAPPEAR,
		...
		0x131: PACKET.ZC.STORE_ENTRY,
		0x132: PACKET.ZC.DISAPPEAR_ENTRY,
		0x133: PACKET.ZC.PC_PURCHASE_ITEMLIST_FROMMC,
		0x135: PACKET.ZC.PC_PURCHASE_RESULT_FROMMC,
		...
		0x13b: PACKET.ZC.ACTION_FAILURE,
		0x13c: PACKET.ZC.EQUIP_ARROW,
		0x13d: PACKET.ZC.RECOVERY,
		0x13e: PACKET.ZC.USESKILL_ACK, // partially
		0x141: PACKET.ZC.COUPLESTATUS, // ok
		0x142: PACKET.ZC.OPEN_EDITDLG, // ok
		0x144: PACKET.ZC.COMPASS,
		0x145: PACKET.ZC.SHOW_IMAGE, // ok
		0x147: PACKET.ZC.AUTORUN_SKILL,
		0x148: PACKET.ZC.RESURRECTION,
		0x14a: PACKET.ZC.ACK_GIVE_MANNER_POINT,
		0x14b: PACKET.ZC.NOTIFY_MANNER_POINT_GIVEN,
		0x14c: PACKET.ZC.MYGUILD_BASIC_INFO,
		0x14e: PACKET.ZC.ACK_GUILD_MENUINTERFACE,
		0x150: PACKET.ZC.GUILD_INFO,
		0x152: PACKET.ZC.GUILD_EMBLEM_IMG,
		0x154: PACKET.ZC.MEMBERMGR_INFO,
		0x156: PACKET.ZC.ACK_REQ_CHANGE_MEMBERS,
		0x158: PACKET.ZC.ACK_OPEN_MEMBER_INFO,
		0x15a: PACKET.ZC.ACK_LEAVE_GUILD,
		0x15c: PACKET.ZC.ACK_BAN_GUILD,
		0x15e: PACKET.ZC.ACK_DISORGANIZE_GUILD_RESULT,
		0x15f: PACKET.ZC.ACK_DISORGANIZE_GUILD,
		0x160: PACKET.ZC.POSITION_INFO,
		0x162: PACKET.ZC.GUILD_SKILLINFO,
		0x163: PACKET.ZC.BAN_LIST,
		0x164: PACKET.ZC.OTHER_GUILD_LIST,
		0x166: PACKET.ZC.POSITION_ID_NAME_INFO,
		0x167: PACKET.ZC.RESULT_MAKE_GUILD,
		0x169: PACKET.ZC.ACK_REQ_JOIN_GUILD,
		0x16a: PACKET.ZC.REQ_JOIN_GUILD,
		0x16c: PACKET.ZC.UPDATE_GDID,
		0x16d: PACKET.ZC.UPDATE_CHARSTAT,
		0x16f: PACKET.ZC.GUILD_NOTICE,
		0x171: PACKET.ZC.REQ_ALLY_GUILD,
		0x173: PACKET.ZC.ACK_REQ_ALLY_GUILD,
		0x174: PACKET.ZC.ACK_CHANGE_GUILD_POSITIONINFO,
		0x176: PACKET.ZC.ACK_GUILD_MEMBER_INFO,
		0x177: PACKET.ZC.ITEMIDENTIFY_LIST,
		0x179: PACKET.ZC.ACK_ITEMIDENTIFY,
		0x17b: PACKET.ZC.ITEMCOMPOSITION_LIST,
		0x17d: PACKET.ZC.ACK_ITEMCOMPOSITION,
		0x17f: PACKET.ZC.GUILD_CHAT,
		0x181: PACKET.ZC.ACK_REQ_HOSTILE_GUILD,
		0x182: PACKET.ZC.MEMBER_ADD,
		0x184: PACKET.ZC.DELETE_RELATED_GUILD,
		0x185: PACKET.ZC.ADD_RELATED_GUILD,
		0x186: PACKET.ZC.COLLECTORDEAD,
		0x188: PACKET.ZC.ACK_ITEMREFINING,
		0x189: PACKET.ZC.NOTIFY_MAPINFO,
		...
		0x196: PACKET.ZC.MSG_STATE_CHANGE,
		...
		0x1e9: PACKET.ZC.ADD_MEMBER_TO_GROUP2,
		0x1ea: PACKET.ZC.CONGRATULATION,
		0x1eb: PACKET.ZC.NOTIFY_POSITION_TO_GUILDM,
		0x1ec: PACKET.ZC.GUILD_MEMBER_MAP_CHANGE,
		0x1ee: PACKET.ZC.NORMAL_ITEMLIST2,
		0x1ef: PACKET.ZC.CART_NORMAL_ITEMLIST2,
		0x1f0: PACKET.ZC.STORE_NORMAL_ITEMLIST2,
		0x1f1: PACKET.AC.NOTIFY_ERROR,
		0x1f2: PACKET.ZC.UPDATE_CHARSTAT2,
		0x1f3: PACKET.ZC.NOTIFY_EFFECT2,
		...
		0x206: PACKET.ZC.FRIENDS_STATE,
		0x207: PACKET.ZC.REQ_ADD_FRIENDS,
		0x209: PACKET.ZC.ADD_FRIENDS_LIST,
		0x20a: PACKET.ZC.DELETE_FRIENDS,
		...
		0x284: PACKET.ZC.NOTIFY_EFFECT3,
		...
		0x295: PACKET.ZC.EQUIPMENT_ITEMLIST2,
		0x296: PACKET.ZC.STORE_EQUIPMENT_ITEMLIST2,
		...
		0x2c5: PACKET.ZC.PARTY_JOIN_REQ_ACK,
		0x2c6: PACKET.ZC.PARTY_JOIN_REQ,
		...
		0x2d0: PACKET.ZC.EQUIPMENT_ITEMLIST3,
		0x2d1: PACKET.ZC.STORE_EQUIPMENT_ITEMLIST3,
		...
		0x2e8: PACKET.ZC.NORMAL_ITEMLIST3,
		0x2e9: PACKET.ZC.CART_NORMAL_ITEMLIST3,
		0x2ea: PACKET.ZC.STORE_NORMAL_ITEMLIST3,
		...
		0x2f0: PACKET.ZC.PROGRESS,
		0x2f2: PACKET.ZC.PROGRESS_CANCEL,
		...
		0x43f: PACKET.ZC.MSG_STATE_CHANGE2,
		...
		0x7d8: PACKET.ZC.REQ_GROUPINFO_CHANGE_V2,
		...
		0x7fa: PACKET.ZC.DELETE_ITEM_FROM_BODY,
		0x7fb: PACKET.ZC.USESKILL_ACK2, // partially
		0x7fc: PACKET.ZC.CHANGE_GROUP_MASTER,
		0x7fe: PACKET.ZC.PLAY_NPC_BGM,
		0x7ff: PACKET.ZC.DEFINE_CHECK,
		0x800: PACKET.ZC.PC_PURCHASE_ITEMLIST_FROMMC2,
		...
		0x80e: PACKET.ZC.NOTIFY_HP_TO_GROUPM_R2,
		...
		0x814: PACKET.ZC.BUYING_STORE_ENTRY,
		0x816: PACKET.ZC.DISAPPEAR_BUYING_STORE_ENTRY,
		...
		0x839: PACKET.ZC.ACK_BAN_GUILD_SSO,
